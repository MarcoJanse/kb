# Bicep Deployment Azure Landing Zone (ALZ) for ICTStuff

- [Bicep Deployment Azure Landing Zone (ALZ) for ICTStuff](#bicep-deployment-azure-landing-zone-alz-for-ictstuff)
...
These are some personal notes during deployment of the Azure Landing Zone on my personal Azure tenant (ICTStuff)
